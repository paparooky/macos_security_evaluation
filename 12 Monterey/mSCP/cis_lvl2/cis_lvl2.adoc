...
:show_STIG!:
:show_cis:
:version: Monterey Guidance, Revision 3 (2022-10-20)
:os: 12.0
:proj-title: macOS 12.0: Security Configuration - CIS_LVL2
...
{document-subtitle2}
Monterey Guidance, Revision 3 (2022-10-20)
...
This guide describes the actions to take when securing a macOS 12.0 system against the CIS_LVL2 baseline.
