...
:show_STIG!:
:show_cis:
:version: Big Sur Guidance, Revision 6 (2022-10-20)
:os: 11.0
:proj-title: macOS 11.0: Security Configuration - CIS_LVL2
:document-title: macOS 11.0
:document-subtitle:  Security Configuration - CIS_LVL2
:document-subtitle2:
ifdef::backend-pdf[]
= {document-title}: {document-subtitle}
{document-subtitle2}
Big Sur Guidance, Revision 6 (2022-10-20)
...
When "expire-after" is set to "60d OR 1G", the audit service will not delete audit logs until the log data is at least seven days old.
...
List of CIS controls that are manual checks.
...
2.13 Audit Notification Settings +
|===
